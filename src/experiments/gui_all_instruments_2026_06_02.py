...
import nnmr_magnet_motion_2026_05_27 as mag
...
class InstWidget(QWidget):
    ...
    def init_mag_widgets(self):
        ...
        magnet_instruction_font = QFont(self.label_font)
        magnet_instruction_font.setItalic(True)
        self.magnet_instruction_header_label.setFont(magnet_instruction_font)
        self.magnet_instruction_header_label.setAlignment(
            Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter
        )
        self.magnet_instruction_header_label.setFixedHeight(23)
    ...
    def layouts(self):
        ...
        self.status_bar_layout.addWidget(self.status_scroll_area, 3, 1)
    ...
    def single_move_clicked(self, stage):
        ...
        if self.all_disable_button.text() == "DISABLE ALL STAGES":
            if stage == "zaber":
                ...
                self.status_label.setText("Magnet Status: Invalid stage for move command.")
        else:
            self.status_label.setStyleSheet(
                "color: black; background-color: red; border: 1px solid black;"
            )
            self.status_label.setText("Magnet Status: Cannot move - stages are disabled.")
    ...
    def all_standby_clicked(self):
        ...
        if self.all_disable_button.text() == "DISABLE ALL STAGES":
            ...
            self.status_label.setText("Magnet Status: Cannot move to standby - stages are disabled.")
    ...
    def check_queue_from_mag(self):
        ...
        while not self.q.empty():  # if there is something in the queue
            ...
            if queueText[0] == "done":
                ...
                self.status_label.setText("Magnet Status: Move completed successfully.")
                ...
                self.status_label.setText("Magnet Status: Move stopped by user.")
                ...
                self.status_label.setText("Magnet Status: Move in progress...")
