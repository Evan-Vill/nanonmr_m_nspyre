...
class CalcWidget(QWidget):
    def __init__(self):
        ...
        self.setStyleSheet(f"""
            ...
            QLineEdit {{
                ...
                color: {self.text_primary};
                border: 1px solid {self.accent_secondary};
                border-radius: 4px;
                padding: 5px;
                font-size: 11px;
            }}
    ...
    def diffusion_widget_init(self):
        ...
        self.diffuse_label.setFixedHeight(28)
        ...
        self.diffuse_params_widget.setStyleSheet(f"background-color: {self.bg_light}; color: {self.text_primary}")
        ...
        self.diffusion_coef_label.setFont(QFont(self.font, 9))
        ...
        self.tcorr_label.setFont(QFont(self.font, 9))
        ...
        self.fwhm_label.setFont(QFont(self.font, 9))
    ...
    def b_widget_init(self):
        ...
        self.b_label.setFixedHeight(28)
        ...
        self.nv_m_label.setStyleSheet(f"background-color: {self.bg_surface}; border: 1px solid {self.accent_secondary}; border-top-left-radius: 4px; border-top-right-radius: 4px; color: {self.text_primary}; padding: 8px")
        self.nv_m_label.setFixedHeight(50)
        self.nv_m_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.nv_m_label.setFont(QFont(self.font, 9))
        
        self.nv_p_label = QLabel("NV + Resonance:\n—")
        self.nv_p_label.setStyleSheet(f"background-color: {self.bg_surface}; border: 1px solid {self.accent_secondary}; border-bottom-left-radius: 4px; border-bottom-right-radius: 4px; color: {self.text_primary}; padding: 8px")
        self.nv_p_label.setFixedHeight(50)
        self.nv_p_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.nv_p_label.setFont(QFont(self.font, 9))
        ...
        self.b_output_label.setStyleSheet(f"color: {self.text_secondary}; font-size: 10px;")
        self.b_output = QLabel("—")
        self.b_output.setStyleSheet(f"color: {self.text_primary}; font-weight: bold; font-size: 11px;")
        ...
        self.larmor_output.setStyleSheet(f"background-color: {self.bg_surface}; border: 1px solid {self.accent_secondary}; border-top-left-radius: 4px; border-top-right-radius: 4px; color: {self.text_primary}; padding: 8px;")
        self.larmor_output.setFixedHeight(50)
        self.larmor_output.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.larmor_output.setFont(QFont(self.font, 9))
        
        self.period_output = QLabel("Period:\n—")
        self.period_output.setStyleSheet(f"background-color: {self.bg_surface}; border: 1px solid {self.accent_secondary}; color: {self.text_primary}; padding: 8px")
        self.period_output.setFixedHeight(50)
        self.period_output.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.period_output.setFont(QFont(self.font, 9))
        
        self.halfperiod_output = QLabel("Half Period:\n—")
        self.halfperiod_output.setStyleSheet(f"background-color: {self.bg_surface}; border: 1px solid {self.accent_secondary}; border-bottom-left-radius: 4px; border-bottom-right-radius: 4px; color: {self.text_primary}; padding: 8px")
        self.halfperiod_output.setFixedHeight(50)
        self.halfperiod_output.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.halfperiod_output.setFont(QFont(self.font, 9))

    def power_widget_init(self):
        self.power_label = QLabel("Power Unit Conversion")
        self.power_label.setFixedHeight(28)
        ...
        self.watts_output_label.setStyleSheet(f"color: {self.text_secondary}; font-size: 10px; font-weight: bold;")
        ...
        self.milliwatts_output_label.setStyleSheet(f"color: {self.text_secondary}; font-size: 10px; font-weight: bold;")
        ...
        self.dbm_output_label.setStyleSheet(f"color: {self.text_secondary}; font-size: 10px; font-weight: bold;")
    ...
    def convert_to_gauss(self):
        ...
        self.b_output.setText(f"{B_field:.4f} G")
        ...
        self.nv_m_label.setText(f"NV − Resonance:\n{nv_minus1:.6f} GHz")
        self.nv_p_label.setText(f"NV + Resonance:\n{nv_plus1:.6f} GHz")
    ...
    def tir_widget_init(self):
        ...
        self.tir_label.setFixedHeight(28)
        ...
        self.medium1_label.setStyleSheet(f"color: {self.text_secondary}; font-size: 10px; font-weight: bold;")
        ...
        self.medium2_label.setStyleSheet(f"color: {self.text_secondary}; font-size: 10px; font-weight: bold;")
        ...
        self.tir_angle_label.setStyleSheet(f"background-color: {self.bg_surface}; border: 1px solid {self.accent_secondary}; border-radius: 4px; color: {self.text_primary}; padding: 8px;")
        self.tir_angle_label.setFixedHeight(50)
    ...
    def widgetlayout(self):
        ...
        self.diffusion_frame.setStyleSheet(f"QFrame#dFrame {{background-color: {self.bg_light}; border-radius: 6px;}}")
        ...
        self.diffusion_frame.setMinimumHeight(370)
        ...
        self.b_frame.setStyleSheet(f"background-color: {self.bg_light}; border-radius: 6px;")
        self.b_frame.setMinimumWidth(520)
        self.b_frame.setMinimumHeight(370)
        ...
        # B Field Output
        self.b_output_frame = QFrame(self)
        self.b_output_layout = QHBoxLayout(self.b_output_frame)
        self.b_output_layout.setSpacing(10)
        self.b_output_layout.setContentsMargins(0, 0, 0, 0)
        self.b_output_layout.addWidget(self.b_output_label, 0, Qt.AlignmentFlag.AlignRight)
        self.b_output_layout.addWidget(self.b_output)
        self.b_output_layout.addStretch()
        
        # NV Resonances
        self.nv_frame = QFrame(self)
        self.nv_layout = QVBoxLayout(self.nv_frame)
        self.nv_layout.setSpacing(0)
        ...
        self.spin_label.setStyleSheet(f"color: {self.text_secondary}; font-size: 10px; font-weight: bold;")
        ...
        self.b_frame_layout.addWidget(self.b_output_frame, 2, 0, 1, 2)
        self.b_frame_layout.addWidget(self.b_content_frame, 3, 0, 1, 2)
        ...
        self.power_frame.setStyleSheet(f"background-color: {self.bg_light}; border-radius: 6px;")
        self.power_frame.setMinimumHeight(180)
        ...
        self.tir_frame.setStyleSheet(f"background-color: {self.bg_light}; border-radius: 6px;")
        self.tir_frame.setMinimumHeight(160)
        ...
        self.tir_input_layout.addStretch()
