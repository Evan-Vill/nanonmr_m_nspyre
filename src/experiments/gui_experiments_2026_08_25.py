...
import experiment_defaults_2026_08_25
import nv_experiments_2026_07_13
...
class ExpWidget(QWidget):
    ...
    def __init__(self, status_queue=None):
        ...
        self.all_defaults = experiment_defaults_2026_08_25.build_experiment_defaults()
        ...
        self.exp_dict = {
            ...
            "Rabi Power Calibration": [
                "power_calibration_scan",
                self.all_defaults["power_calibration_params_defaults"],
                self.all_defaults["power_calibration_mw_params_defaults"],
                "rabi power calibration",
                self.all_defaults["laser_params_defaults"],
                self.all_defaults["digitizer_defaults"],
            ],
            ...
            "Nitrogen T1": [
                 "Nitrogen_T1_scan",
                 self.all_defaults['nitrogen_t1_params_defaults'],
                 self.all_defaults['nitrogen_t1_mw_params_defaults'],
                 'nv t1',
                 self.all_defaults['laser_params_defaults'],
                 self.all_defaults['digitizer_defaults']
             ],
            ...
            "CNOT NE time": [
                 "cnot_ne_time_scan",
                 self.all_defaults['cnot_ne_time_params_defaults'],
                 self.all_defaults['cnot_ne_time_mw_params_defaults'],
                 'cnot ne',
                 self.all_defaults['laser_params_defaults'],
                 self.all_defaults['digitizer_defaults']
             ],
            ...
            "QLE XY8": [
                 "qle_xy8_scan",
                 self.all_defaults['qle_xy8_params_defaults'],
                 self.all_defaults['qle_xy8_mw_params_defaults'],
                 'qle t2',
                 self.all_defaults['laser_params_defaults'],
                 self.all_defaults['digitizer_defaults']
             ],
            ...
            "QLE Corr Spec": [
                 "qle_corr_spec_scan",
                 self.all_defaults['qle_corr_spec_params_defaults'],
                 self.all_defaults['qle_corr_spec_mw_params_defaults'],
                 'qle corr spec',
                 self.all_defaults['laser_params_defaults'],
                 self.all_defaults['digitizer_defaults']
             ],
    ...
    def create_params_widget(self, tag, defaults):
        match tag:
            ...
            case "Rabi Power Calibration":
                num_pts_widget = SpinBox(
                    value=defaults["num_pts"],
                    int=True,
                    bounds=(1, None),
                    dec=True,
                )
            ...
            case "Nitrogen T1":
                params = {
                    ...
                    "start": {
                        "display_text": "Start Optical T1 Time: ",
                        "widget": SpinBox(
                            value=defaults["start"],
                            suffix="s",
                            siPrefix=True,
                    ...
                    "stop": {
                        "display_text": "Stop Optical T1 Time: ",
                        "widget": SpinBox(
                            value=defaults["stop"],
                            suffix="s",
                            siPrefix=True,
            ...
            case "QLE XY8":
                params = {
                    ...
                    "start": {
                        "display_text": "Start Free-Precession Time: ",
                        "widget": SpinBox(
                            value=defaults["start"],
                            suffix="s",
                            siPrefix=True,
                    ...
                    "stop": {
                        "display_text": "Stop Free-Precession Time: ",
                        "widget": SpinBox(
                            value=defaults["stop"],
                            suffix="s",
                            siPrefix=True,
                    ...
                    "num_pts": {
                        "display_text": "# Free-Precession Times: ",
                        "widget": SpinBox(
                            value=defaults["num_pts"],
                            int=True,
                            bounds=(1, None),
            ...
            case "QLE Corr Spec":
                params = {
                    ...
                    "start": {
                        "display_text": "Start Correlation Time: ",
                        "widget": SpinBox(
                            value=defaults["start"],
                            suffix="s",
                            siPrefix=True,
                    ...
                    "stop": {
                        "display_text": "Stop Correlation Time: ",
                        "widget": SpinBox(
                            value=defaults["stop"],
                            suffix="s",
                            siPrefix=True,
                    ...
                    "num_pts": {
                        "display_text": "# Correlation Times: ",
                        "widget": SpinBox(
                            value=defaults["num_pts"],
                            int=True,
                            bounds=(1, None),
    ...
    def create_mw_params_widget(self, tag, defaults, overrides=None):
        ...
        match tag:
            ...
            case "Rabi Power Calibration":
                params = {
                    "freq": {
                        "display_text": "NV Frequency: ",
                        "widget": SpinBox(
                            value=overrides.get("freq", defaults["freq"]),
                            suffix="Hz",
                            siPrefix=True,
                            bounds=(100e3, 6e9),
                            dec=True,
                    ...
                    "power_start": {
                        "display_text": "Start Applied MW Power: ",
                        "widget": SpinBox(
                            value=defaults["power_start"],
                            suffix="V",
                            bounds=(0, 0.45),
                            dec=True,
                        ),
                    ...
                    "power_stop": {
                        "display_text": "Stop Applied MW Power: ",
                        "widget": SpinBox(
                            value=defaults["power_stop"],
                            suffix="V",
                            bounds=(0, 0.45),
                            dec=True,
                        ),
                    ...
                    "power_num_pts": {
                        "display_text": "# Applied MW Powers: ",
                        "widget": SpinBox(
                            value=defaults["power_num_pts"],
                            int=True,
                            bounds=(1, None),
                        ),
                    },
            ...
            case 'Nitrogen T1': #TODO: add MW parameters
                params = {
                    "cnot_ne": {
                        "display_text": "Fixed CNOT NE Time: ",
                        "widget": SpinBox(
                            value=defaults["cnot_ne"],
                            suffix="s",
                            siPrefix=True,
                            bounds=(0, None),
                            dec=True,
            ...
            case 'CNOT NE time':
                params = {
                    ...
                    "rf_freq": {
                        "display_text": "RF Frequency: ",
                        "widget": SpinBox(
                            value=defaults["rf_freq"],
                            suffix="Hz",
                            siPrefix=True,
                            bounds=(1, 1e9),
                            dec=True,
                    ...
                    "rf_phase": {
                        "display_text": "RF Phase: ",
                        "widget": SpinBox(
                            value=defaults["rf_phase"],
                            suffix="°",
                            int=True,
                            bounds=(0, 360),
                        ),
                    ...
                    "cnot_en": {
                        "display_text": "Fixed CNOT EN Time: ",
                        "widget": SpinBox(
                            value=defaults["cnot_en"],
                            suffix="s",
                            siPrefix=True,
                            bounds=(0, None),
                            dec=True,
                    ...
                    "rf_time_start": {
                        "display_text": "Start RF Pulse Time: ",
                        "widget": SpinBox(
                            value=defaults["rf_time_start"],
                            suffix="s",
                            siPrefix=True,
                            bounds=(0, None),
                            dec=True,
                    ...
                    "rf_time_stop": {
                        "display_text": "Stop RF Pulse Time: ",
                        "widget": SpinBox(
                            value=defaults["rf_time_stop"],
                            suffix="s",
                            siPrefix=True,
                            bounds=(0, None),
                            dec=True,
                    ...
                    "rf_time_num_pts": {
                        "display_text": "# RF Pulse Times: ",
                        "widget": SpinBox(
                            value=defaults["rf_time_num_pts"],
                            int=True,
                            bounds=(1, None),
                        ),
                    },
            ...
            case 'QLE XY8':
                params = {
                    "freq": {"display_text": "NV Frequency: ","widget": SpinBox(
                            value=overrides.get("freq", defaults["freq"]),
                            suffix="Hz",
                            siPrefix=True,
                            bounds=(100e3, 6e9),
            ...
            case 'QLE Corr Spec':
                params = {
                    ...
                    "readout_reps": {
                        "display_text": "# Readout Repetitions: ",
                        "widget": SpinBox(
                            value=defaults["readout_reps"],
                            int=True,
                            bounds=(1, None),
                        ),
                    },
    ...
    def run(self):
        ...
        #     self.extra_kwarg_params['seq'] = self.experiments.currentText()
            ...
            if self.daq_b1.isChecked(): # digitizer settings
                reload(nv_experiments_2026_07_13)
                # call the function in a new process
                self.run_proc.run(
                    run_experiment,
                    exp_cls = nv_experiments_2026_07_13.SpinMeasurements,
