...
class Pulses():
    ...
    ALL UNITS: [ns]
    '''
    def __init__(self, laser_time = 30e3, initial_delay = 100, singlet_decay = 500, readout_time = 2500, 
    ...
    def Pulsed_ODMR(self, num_freqs, pi_time, read_time):
        '''
    ...
    def Pulsed_ODMR_RF(self, num_freqs, pi_time, rf_period, read_time):
        '''
        Pulsed ODMR sequence
        '''
        ## Run a MW pulse at pi time, then measure the signal
    ...
    def Rabi(self, params, read_time):
        '''
        Rabi sequence
        '''
    ...
    def Diff_T1(self, params, pi_xy, pi_time, read_time):
        '''
    ...
    def DQ(self, params, pi_xy, pi_time_minus, pi_time_plus, read_time):
        '''
        ...
        def SingleDQ(tau_time):
            ...
            # digitizer trigger timing
            clock_off1 = laser_off1 + self.laser_time + laser_off2
            clock_off1_plus = laser_off1 + self.laser_time + laser_off2_plus
            clock_off2 = - self.clock_time + read_time + laser_off3
            ...
            # define sequence structure for laser
            laser_seq = [(laser_off1, 0), (self.laser_time, 1), (laser_off2, 0), (read_time, 1), (laser_off3, 0)]
            laser_seq_plus = [(laser_off1, 0), (self.laser_time, 1), (laser_off2_plus, 0), (read_time, 1), (laser_off3, 0)]
    ...
    def Ramsey(self, params, pihalf_x, pihalf_y, read_time):
    ...
    def Echo(self, params, pihalf_x, pihalf_y, pi_x, pi_y, read_time):
        '''
    ...
    def XY4_N(self, params, pulse_axes, pihalf_x, pihalf_y, pi_x, pi_y, n, read_time):
        '''
    ...
    def XY8_N(self, params, pulse_axes, pihalf_x, pihalf_y, pi_x, pi_y, n, read_time):
        '''
    ...
    def XY8_N_RF(self, params, pulse_axes, pihalf_x, pihalf_y, pi_x, pi_y, n, read_time):
        '''
        XY8-N pulse sequence.
        MW sequence: pi/2(x) - (tau/2 - pi(x) - tau - pi(y) - tau - pi(x) - tau... - pi(y) - tau/2)^N - pi/2(x, -x)
        ...
        def SingleXY8(tau):
            ...
            rf_off_start = laser_off1 + self.laser_time 
    ...
    def CPMG_N(self, params, pulse_axis, pihalf_x, pihalf_y, pi_x, pi_y, n, read_time):
        '''
    ...
    def DEER(self, pihalf_x, pihalf_y, pi_x, pi_y, tau, num_freqs, read_time):
        '''
        DEER pulse sequence.
        MW sequence: pi/2(x) - tau - pi(y) - tau - pi/2(x)
        ...
        def SingleDEER():
            ...
            awg_ref_seq = [(laser_off1 + self.laser_time + laser_off2 + read_time + laser_off3, 0)] # off the entire time
    ...
    def DEER_CD(self, pihalf_x, pihalf_y, pi_x, pi_y, tau, num_freqs, read_time):
        '''
        ...
        def SingleDEERCD():
            ...
            awg_cd_ref_seq = [(laser_off1 + self.laser_time + laser_off2 + read_time + laser_off3, 0)] # off the entire time
    ...
    def DEER_Rabi(self, pihalf_x, pihalf_y, pi_x, pi_y, tau, num_pts, read_time):
        '''
        DEER pulse sequence.
        MW sequence: pi/2(x) - tau - pi(y) - tau - pi/2(x)
    ...
    def DEER_FID(self, params, pihalf_x, pihalf_y, pi_x, pi_y, n, read_time):
            '''
            DEER pulse sequence.
            MW sequence: pi/2(x) - tau - pi(y) - tau - pi/2(x)
    ...
    def DEER_FID_CD(self, params, pihalf_x, pihalf_y, pi_x, pi_y, n, read_time):
            '''
            DEER pulse sequence.
            MW sequence: pi/2(x) - tau - pi(y) - tau - pi/2(x)
            '''
    ...
    def Electron_T1(self, params, tau, pihalf_x, pihalf_y, pi_x, pi_y, dark_pi, read_time):
            '''
    ...
    def Electron_T2(self, params, tau, pihalf_x, pihalf_y, pi_x, pi_y, dark_pi_half, dark_pi, read_time, deer_t2_buffer):
            '''
    ...
    def DEER_Corr_Rabi(self, params, tau, t_corr, pihalf_x, pihalf_y, pi_x, pi_y, read_time):
        '''
    ...
    def Corr_Spectroscopy(self, params, tau, pihalf_x, pihalf_y, pi_x, pi_y, n, read_time):
        '''
