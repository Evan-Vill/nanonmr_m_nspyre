...
class CoboltLaser:
    ...
    def __init__(self, port='COM5', serialnumber=15222, baudrate=115200, powerDownOnDisconnect=False):
        self.serialnumber = serialnumber
        self.port = port
        self.modelnumber = None
        self.baudrate = baudrate
        self.address = None
        self.shouldPowerDownOnDisconnect = powerDownOnDisconnect
    ...
    def __exit__(self, *args):
        if self.shouldPowerDownOnDisconnect:
            self.turn_off()
        self.disconnect()
...
laser1 = CoboltLaser(port='COM5')
laser1.connect()
print(laser1)
print(laser1.get_power())
laser1.turn_on()
print(laser1.get_state())
laser1.disconnect()