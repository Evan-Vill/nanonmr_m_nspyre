...
class Pulses():
    ...
    def CASR_orig(self, nuclear_pihalf, laser_time, singlet_decay, pihalf_x, pihalf_y, pi_x, pi_y, tau, n, mw_buffer_time, read_time, wait_time, n_R):
        '''
    ...
    def CASR_Coil(self, laser_time, singlet_decay, pihalf_x, pihalf_y, pi_x, pi_y, tau, n, mw_buffer_time, read_time, wait_time, n_R):
        ...
        def SingleCASR():
            ...
            # nuclear spin pi/2 initial pulse
            nuclear_spin_continuous_seq = [(self.awg_trig_time, 1), (-self.awg_trig_time + laser_time + laser_off1 + read_time + laser_off2, 0)]
            ...
            # assign sequences to respective channels for seq
            nuclear_spin_ps = nuclear_spin_continuous_seq
            laser_ps = laser_seq*n_R
            dig_ps = dig_clock_seq*n_R
            mw_ps = mw_iq_seq*n_R
