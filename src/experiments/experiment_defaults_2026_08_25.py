def build_experiment_defaults():
    ...
    power_calibration_params_defaults = {
        "runs": 120,
        "iters": 10,
        "start": 0e-9,
        "stop": 200e-9,
    ...
    power_calibration_mw_params_defaults = {
        "freq": 2.87e9,
        "rf_power": 1e-9,
    ...
    nitrogen_t1_mw_params_defaults = {
        "freq": 2.87e9,
        "rf_power": 0.1,
        "rf_freq": 500e3,
        "rf_phase": 0,
    ...
    cnot_ne_time_mw_params_defaults = {
        "freq": 2.87e9,
        "sideband_power": 0.45,
        "sideband_freq": 30e6,
        "rf_power": 0.1,
    ...
    qle_corr_spec_mw_params_defaults = {
        "freq": 2.87e9,
        "rf_power": 1e-9,
        "pulse_axis": "y",
        "NT1": 100e-6,
    ...
    return {
        'power_calibration_params_defaults': power_calibration_params_defaults,
        'power_calibration_mw_params_defaults': power_calibration_mw_params_defaults,
        'cnot_ne_time_params_defaults': cnot_ne_time_params_defaults,
        'cnot_ne_time_mw_params_defaults': cnot_ne_time_mw_params_defaults,
        'nitrogen_t1_params_defaults': nitrogen_t1_params_defaults,
        'nitrogen_t1_mw_params_defaults': nitrogen_t1_mw_params_defaults,
        'qle_xy8_params_defaults': qle_xy8_params_defaults,
        'qle_xy8_mw_params_defaults': qle_xy8_mw_params_defaults,
        'qle_corr_spec_params_defaults': qle_corr_spec_params_defaults,
        'qle_corr_spec_mw_params_defaults': qle_corr_spec_mw_params_defaults,
        ...
        # Option lists for combobox reordering in save_params_clicked
        'sideband_opts': sideband_opts,
        'dig_ro_chan_opts': dig_ro_chan_opts,
        'dig_coupling_opts': dig_coupling_opts,
        'dig_termination_opts': dig_termination_opts,
        'rabi_axis_opts': rabi_axis_opts,
        'opt_t1_array_opts': opt_t1_array_opts,
        'mw_t1_array_opts': mw_t1_array_opts,
        't2_array_opts': t2_array_opts,
        't2_rf_array_opts': t2_rf_array_opts,
        't2_seq_opts': t2_seq_opts,
        'dq_array_opts': dq_array_opts,
        'fid_array_opts': fid_array_opts,
        'fid_cd_array_opts': fid_cd_array_opts,
        'corr_t1_array_opts': corr_t1_array_opts,
        'deer_drive_opts': deer_drive_opts,
        'fid_drive_opts': fid_drive_opts,
        'corr_spec_sig_opts': corr_spec_sig_opts,
        'casr_sig_opts': casr_sig_opts,
        'dnp_opts': dnp_opts,
    }