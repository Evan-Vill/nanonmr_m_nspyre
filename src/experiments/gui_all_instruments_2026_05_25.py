...
class InstWidget(QWidget):
    ...
    def __init__(self, status_queue=None):
        ...
        self.all_disable_button = QPushButton("ENABLE MAGNET STAGES")
    ...
    def _setup_professional_styles(self):
        ...
        self.label_font = QtGui.QFont("Segoe UI", 12)
        ...
        self.all_disable_button_style = """
            QPushButton {
                background-color: #1A7A7A;
                color: white;
                border: 1px solid #5EBBBB;
                border-radius: 4px;
                padding: 6px 12px;
                font-weight: bold;
            }
        ...
        # B field button: Dark Red
        self.b_field_button_style = """
            QPushButton {
    ...
    def init_b_widgets(self):
        ...
        self.phi_label.setFont(self.larger_label_font)

        self.phi_position = QLineEdit()
        self.phi_position.setStyleSheet(self.lineedit_style)
        self.phi_position.setFont(self.label_font)

        self.target_b_label = QLabel("Field (G): ")
        self.target_b_label.setFixedHeight(40)
        self.target_b_label.setFont(self.larger_label_font)

        self.target_b_value = QLineEdit()
        self.target_b_value.setStyleSheet(self.lineedit_style)
        self.target_b_value.setFont(self.label_font)

        self.b_execute_button = QPushButton("Go To B Field")
        self.b_execute_button.setStyleSheet(self.b_field_button_style)
        self.b_execute_button.setFont(self.label_font)
    ...
    def init_r_widgets(self):
        ...
        self.r_execute_move_button.setStyleSheet(self.magnet_button_style)
        ...
        self.r_stop_button = QPushButton("STOP")
        self.r_stop_button.setStyleSheet(self.magnet_button_style)
    ...
    def init_polar_widgets(self):
        ...
        self.polar_move_types.setStyleSheet(self.awg_combobox_style)
        self.polar_move_label = QLabel("Move \u03b8 to: ")
        ...
        self.polar_execute_move_button.setStyleSheet(self.magnet_button_style)
        ...
        self.polar_stop_button = QPushButton("STOP")
        self.polar_stop_button.setStyleSheet(self.magnet_button_style)
    ...
    def init_azi_widgets(self):
        ...
        self.azi_move_types.setStyleSheet(self.awg_combobox_style)
        self.azi_move_label = QLabel("Move \u03c6 to: ")
        ...
        self.azi_execute_move_button.setStyleSheet(self.magnet_button_style)
        ...
        self.azi_stop_button = QPushButton("STOP")
        self.azi_stop_button.setStyleSheet(self.magnet_button_style)
    ...
    def init_sg396_widgets(self):
        ...
        self.sg396_emit_button.setStyleSheet(self.magnet_button_style)
        ...
        self.sg396_stop_button.setStyleSheet(self.magnet_button_style)
    ...
    def init_laser_widgets(self):
        ...
        self.laser_b1.setFont(self.label_font)
        ...
        self.laser_b2.setFont(self.label_font)
        ...
        self.optics_flipper_b1.setFont(self.larger_label_font)
        ...
        self.optics_flipper_b2.setFont(self.larger_label_font)
        ...
        self.laser_power_set_button.setFont(self.label_font)
        ...
        self.laser_current_setpt_label.setFont(self.label_font)
        ...
        self.laser_alarm_reset_button.setStyleSheet(self.laser_button_style)
        self.laser_alarm_reset_button.setFont(self.label_font)
    ...
    def init_awg_widgets(self):
        ...
        self.awg_volt_range_ch3_combobox.setStyleSheet(self.awg_combobox_style)
        ...
        self.awg_volt_range_ch4_combobox.setStyleSheet(self.awg_combobox_style)
        ...
        self.awg_samp_rate_group_0_combobox.setStyleSheet(self.awg_combobox_style)
        ...
        self.awg_samp_rate_group_1_combobox.setStyleSheet(self.awg_combobox_style)
    ...
    def init_flipper_widgets(self):
        ...
        self.flipper_b1.setFont(self.larger_label_font)
        ...
        self.flipper_b2.setFont(self.larger_label_font)
    ...
    def layouts(self):
        ...
        self.r_layout.addWidget(self.r_label, 1, 1, Qt.AlignmentFlag.AlignCenter)
        self.r_layout.addWidget(self.r_move_checkbox, 1, 2)
        self.r_layout.addWidget(self.r_move_types, 1, 3)
        ...
        self.r_layout.addWidget(self.r_execute_move_button, 1, 4, 2, 1)
        self.r_layout.addWidget(self.r_stop_button, 1, 5, 2, 1)
        ...
        self.polar_layout.addWidget(self.polar_label, 1, 1)
        self.polar_layout.addWidget(self.polar_move_checkbox, 1, 2)
        self.polar_layout.addWidget(self.polar_move_types, 1, 3)
        ...
        self.polar_layout.addWidget(self.polar_execute_move_button, 1, 4, 2, 1)
        self.polar_layout.addWidget(self.polar_stop_button, 1, 5, 2, 1)
        ...
        self.azi_layout.addWidget(self.azi_label, 1, 1)
        self.azi_layout.addWidget(self.azi_move_checkbox, 1, 2)
        self.azi_layout.addWidget(self.azi_move_types, 1, 3)
        ...
        self.azi_layout.addWidget(self.azi_execute_move_button, 1, 4, 2, 1)
        self.azi_layout.addWidget(self.azi_stop_button, 1, 5, 2, 1)
        ...
        self.status_bar_layout.addWidget(self.all_disable_button, 1, 1)
        self.status_bar_layout.addWidget(self.all_standby_button, 2, 1)
        self.status_bar_layout.addWidget(self.status_label, 3, 1)

        self.individual_cmds_layout = QGridLayout()
        self.individual_cmds_layout.setSpacing(0)
        self.individual_cmds_layout.addWidget(self.magnet_frame, 1, 1, 1, 2)
        self.individual_cmds_layout.addWidget(self.thor_azi_frame, 2, 1, 1, 1)
        self.individual_cmds_layout.addWidget(self.thor_polar_frame, 3, 1, 1, 1)
        self.individual_cmds_layout.addWidget(self.zaber_frame, 4, 1, 1, 1)
        self.individual_cmds_layout.addWidget(self.b_frame, 5, 1, 1, 1)
        self.individual_cmds_layout.addWidget(self.status_frame, 1, 2, 5, 1)
    ...
    def azi_move_type_changed(self):
        match self.azi_move_types.currentText():
            ...
            case _:
                self.azi_move_label.setText("Move \u03c6 to: ")
    ...
    def polar_move_type_changed(self):
        match self.polar_move_types.currentText():
            ...
            case _:
                self.polar_move_label.setText("Move \u03b8 to: ")
    ...
    def single_move_clicked(self, stage):
        ...
        if self.all_disable_button.text() == "DISABLE MAGNET STAGES":
            if stage == "zaber":
    ...
    def all_disable_clicked(self):
        ...
        if self.all_disable_button.text() == "DISABLE MAGNET STAGES":
            self.all_disable_proc.run(mag_control.disable_all)
            self.all_disable_button.setText("ENABLE MAGNET STAGES")
            self.status_label.setStyleSheet(
            ...
            self.all_disable_button.setText("DISABLE MAGNET STAGES")
            self.status_label.setStyleSheet(
    ...
    def all_standby_clicked(self):
        ...
        if self.all_disable_button.text() == "DISABLE MAGNET STAGES":
            ...
            self.status_label.setStyleSheet(
                "color: black; background-color: red; border: 1px solid #555555;"
            )
            self.status_label.setText("Magnet Status: CANNOT MOVE STAGE IS PARKED")
