    ...
    def fit_selector(self):
        ...
        match self.fit_select.currentText():
                ...
                case 'Modulated Str. Exp.':
                    self.fit_params_widget = FitParamsWidget(self.create_fit_params_widget('Fit Modulated Str Exp', self.fit_mod_str_exp_defaults), get_param_value_funs = {ComboBox: self.get_combobox_val})  
