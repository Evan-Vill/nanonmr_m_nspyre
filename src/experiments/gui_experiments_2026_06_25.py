...
class ExpWidget(QWidget):
    ...
    def __init__(self, status_queue=None):
        ...
        self.exp_dict = {
            ...
            # "Nitrogen T1": [
            #     "Nitrogen_T1_scan",
            #     self.all_defaults['n_t1_params_defaults'],
            #     self.all_defaults['n_t1_mw_params_defaults'],
            #     'n t1',
            #     self.all_defaults['laser_params_defaults'],
            #     self.all_defaults['digitizer_defaults']
            # ],
            ...
            # "CNOT Calibration": [
            #     "CNOT_cal_scan",
            #     self.all_defaults['cnot_cal_params_defaults'],
            #     self.all_defaults['cnot_cal_mw_params_defaults'],
            #     'cnot cal',
            #     self.all_defaults['laser_params_defaults'],
            #     self.all_defaults['digitizer_defaults']
            # ],
            ...
            # "QLE T2": [
            #     "QLE_T2_scan",
            #     self.all_defaults['qle_t2_params_defaults'],
            #     self.all_defaults['qle_t2_mw_params_defaults'],
            #     'qle t2',
            #     self.all_defaults['laser_params_defaults'],
            #     self.all_defaults['digitizer_defaults']
            # ],
            ...
            # "QLE NMR Correlation Spectroscopy": [
            #     "QLE_Corr_Spec_scan",
        ...
        match tag:
            ...
            case 'NMR Correlation Spectroscopy':
                params = {
                        ...
                        'n': {'display_text': '# Seqs. (n): ',
                                'widget': SpinBox(value = defaults['n'], int = True, bounds=(1, None))}}
            case 'QLE NMR Correlation Spectroscopy':
                pass
            case 'NMR CASR':
                params = {
                        'freq': {'display_text': 'NV Frequency: ',
