...
class ExpWidget(QWidget):
    ...
    def __init__(self):
        ...
        self.rabi_params_defaults = [12, 10, 0, 500e-9, 100, 2.87e9, 1e-9, self.rabi_axis_opts]   
        ...
        self.fit_label.setGraphicsEffect(self.opacity_effects[13]) # TODO: update opacity effects in GUI
        self.fit_label.setFixedHeight(20)

        self.fit_params_widget.setGraphicsEffect(self.opacity_effects[14])
    ...
    def create_params_widget(self, tag, defaults):
        match tag:
            ...
            case 'Fit ODMR': # -A / (1 + ((x - x0) / gamma) ** 2)
                params = {
                        'A': {'display_text': 'A: ',
                                'widget': SpinBox(value = defaults[0])},
    ...
    def exp_selector(self):
        ...
        try:
            ...
            self.fit_params_widget.setGraphicsEffect(self.opacity_effects[14]) # reset opacity effects
            for i in range(9):
                self.opacity_effects[i].setEnabled(True)
