...
class ExpWidget(QWidget):
    ...
    def __init__(self):
        ...
        self.exp_dict = {"Signal vs Time": ["sigvstime_scan", self.sigvstime_params_defaults, 'sigvstime'],
                    "CW ODMR": ["odmr_scan", self.odmr_params_defaults, 'odmr'],
                    "Laser": [None, self.laser_params_defaults],
                    "Digitizer": [None, self.digitizer_defaults],
                    "Pulsed ODMR": ["pulsed_odmr_scan", self.pulsed_odmr_params_defaults, 'odmr'],
                    "Rabi": ["rabi_scan", self.rabi_params_defaults, 'rabi'],
                    "Optical T1": ["OPT_T1_scan", self.opt_t1_params_defaults, 't1'],
                    "MW T1": ["MW_T1_scan", self.mw_t1_params_defaults, 't1'],
                    "T2": ["T2_scan", self.t2_params_defaults, 't2'],
                    "DQ Relaxation": ["DQ_scan", self.dq_params_defaults, 'dq'],
                    "DEER": ["DEER_scan", self.deer_params_defaults, 'deer'],
                    "DEER Rabi": ["DEER_rabi_scan", self.deer_rabi_params_defaults, 'deer rabi'],
                    "DEER FID": ["DEER_FID_scan", self.deer_fid_params_defaults, 'fid'],
                    "DEER FID Continuous Drive": ["DEER_FID_CD_scan", self.deer_fid_cd_params_defaults, 'fid cd'],
                    "DEER Correlation Rabi": ["DEER_corr_rabi_scan", self.deer_corr_rabi_params_defaults, 'corr rabi'],
                    "DEER T1": ["DEER_corr_T1_scan", self.deer_corr_t1_params_defaults, 'corr t1'],
                    "DEER T2": ["DEER_corr_T1_scan", self.deer_corr_t1_params_defaults, 'corr t2'],
                    "NMR: Correlation Spectroscopy": ["Corr_Spec_scan", self.nmr_params_defaults, 'nmr'],
                    "NMR: CASR": ["CASR_scan", self.casr_params_defaults, 'nmr']}
