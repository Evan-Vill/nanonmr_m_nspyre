...
class SpectrumDigitizer(): 
    ...
    def config(self):
        ...
        # print("SETTINGS: card timeout = ", self.card_timeout*units.s/units.Sa)
        # print("SETTINGS: # segments = ", self.segment_size)
        # print("SETTINGS: sampling freq = ", self.sampling_frequency*units.GHz/units.Sa)
        # print("SETTINGS: AMP = ", self.AMP/units.Sa)
        # print("SETTINGS: pretrig size = ", self.pretrig_size)
        # print("SETTINGS: termination = ", int(self.HF_INPUT_50OHM/units.Sa))
        # print("SETTINGS: num pts = ", self.num_pts_in_exp)
        # print("SETTINGS: termination = ", self.runs)
        # print(spcm.SPC_READAIFEATURES,spcm.SPCM_AI_OFFSPERCENT)
        # print(spcm.SPC_MIINST_MAXADCVALUE)
        ...
        # print("NUM SEGMENT = ", self.num_segment)
        # print("MEM SIZE = ", self.mem_size)
